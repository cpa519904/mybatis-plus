...
public class BaseDal<M extends BaseMapper<T>, T> {
    ...
    public boolean saveOrUpdate(T entity) {
        if (null != entity) {
            ...
            return StringUtils.checkValNull(idVal) || Objects.isNull(baseMapper.selectById((Serializable) idVal)) ? baseMapper.insert(entity)==1 : baseMapper.updateById(entity)==1;
        }
        return false;
    }
